...
data=array(NA, dim=c(nc, nr, nch, nt), dimnames=c("nc", "nr", "channel", "time"))
...
errs1=array(-9999.0, dim=c(nc, nr, nems))
errs2=array(-9999.0, dim=c(nc, nr, nems))
errs3=array(-9999.0, dim=c(nc, nr, nems))
errs4=array(-9999.0, dim=c(nc, nr, nems))
errs5=array(-9999.0, dim=c(nc, nr, nems))
